...
if (!GUILD_ID) { console.error('Usage: GUILD_ID=your_server_id node src/deploy-guild.js'); process.exit(1); }
...
console.log(`Deployed ${data.length} commands to guild ${GUILD_ID} (instant).`);
